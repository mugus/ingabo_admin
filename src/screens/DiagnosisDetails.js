        ...
        <Box sx={{ width: '100%' }}>
            <Grid container style={{paddingTop: '2%'}}>
                ...
                // kinyarwanda
                    ...
                    <Item>
                        <h2 style={{ fontWeight: 'bold', textTransform: 'uppercase'}} color="primary">Ubusobanuro ku ndwara ifata {singledetails.name}</h2>
                        ...
                        <Grid item xs={12} sm={7} md={7} lg={7} xl={7}>
                            Nta bisobanuro birambuye ku ndwara ya {singledetails.name}
                            <hr />
                            <Box
                                component="form"
                                sx={{
                                ...
                                <FormControl sx={{ m: 1, width: 300 }}>
                                    ...
                                    <Select
                                            ...
                                            input={<OutlinedInput label="Imiti yakoreshwa havurwa iyi ndwara" />}
                                            MenuProps={MenuProps}
                                            >
                                            {pro.map((pro) => (
                                                <MenuItem
                            ...
                            <a className="text text-warning" href="../../Crops">subira inyuma ku bihingwa</a>
                        </Grid>
                        </> 
                        }
